...
n_tilde = 100 # number of w_tildes to use to evaluate risk
nbatch = 100
nT = 1
fixedPi = False
...
# ablation=1: remove invariance to permutation of observations # CAUTION: ABLATION NOT YET IMPLEMENTED FOR CATE SETTINGS (This is leftover code from regression setting)
